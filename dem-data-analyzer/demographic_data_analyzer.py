...
def calculate_demographic_data(print_data=True):
    ...
    countries_high_salaries = df.loc[df['salary']=='>50K', 'native-country'].value_counts()/df['native-country'].value_counts()*100
    highest_earning_country = countries_high_salaries.idxmax()
    highest_earning_country_percentage = round(countries_high_salaries.max(), 1)
